...
import sty from "./PlasmicBreadcrumb.module.css"; // plasmic-import: 7UcG5nMlKQ/css
          ...
          defaultContents: (
            <React.Fragment>
              <BreadcrumbItem
                className={classNames(
                  "__wab_instance",
                  sty.breadcrumbItem__gd0AK
                )}
                hierarchy={"parent" as const}
              />

              <BreadcrumbItem
                className={classNames(
                  "__wab_instance",
                  sty.breadcrumbItem__o6Jvq
                )}
                hierarchy={"child" as const}
              />
            </React.Fragment>
          ),
