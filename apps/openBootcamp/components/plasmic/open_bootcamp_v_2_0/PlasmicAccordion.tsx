...
import sty from "./PlasmicAccordion.module.css"; // plasmic-import: I-tcTRhKpZ/css

import Ellipse65Icon from "./icons/PlasmicIcon__Ellipse65"; // plasmic-import: ScRShSrn-QV/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__pPmt)}
      >
        <div
        ...
        >
          ...
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__tD6Sl)}
          >
            {p.renderPlasmicSlot({
