...
import { RoadmapTabsEnum } from '../components/RoadmapSection';
...
import { PlasmicLandingBackend } from '../components/plasmic/open_bootcamp_v_2_0/PlasmicLandingBackend';
...
function LandingBackend({ faqs, testimonials }: LandingBackendProps) {
  ...
  const keyword = 'Curso de Back-End';
  ...
  return (
    <>
      <NextSeo
        title="Empieza nuestro Curso de Back-End y encuentra Trabajo ¡GRATIS!"
        canonical={`${process.env.NEXT_PUBLIC_BASE_URL}/back-end`}
        description="Empieza ya nuestro Curso de Back-End, convértete en un gran developer ¡y consigue un gran empleo!"
        openGraph={{
          type: 'website',
          description: 'Empieza ya nuestro Curso de Back-End, convértete en un gran developer ¡y consigue un gran empleo!',
          title: 'Empieza nuestro Curso de Back-End y encuentra Trabajo ¡GRATIS!',
          url: `${process.env.NEXT_PUBLIC_BASE_URL}/back-end`,
        }}
      />

      <div style={{ position: 'relative' }}>
        <PlasmicLandingBackend
          heroButton={
          ...
          roadmap={<RoadmapSection origen={RoadmapTabsEnum.Backend} />}
            ...
            <Breadcrumb
              breadcrumbItems={
                <>
                  ...
                  <BreadcrumbItem breadcrumbChild={<div>Curso Backend gratis</div>} child="child" />
                </>
              }
            />
          }
      ...
      <BreadcrumbJsonLd
        itemListElements={[
          ...
          { position: 2, name: 'Curso Backend Gratis', item: `${process.env.NEXT_PUBLIC_BASE_URL}/back-end` },
        ]}
      />
    </>
  );
