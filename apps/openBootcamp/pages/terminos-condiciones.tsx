...
import { PlasmicTerminosCondiciones } from '../components/plasmic/open_bootcamp_v_2_0/PlasmicTerminosCondiciones';

import styles from '../styles/Drawer.module.css';
import dynamic from 'next/dynamic';

type LandingTerminosCondicionesProps = {
...
function TerminosCondiciones({ linksList }: LandingTerminosCondicionesProps) {
  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`${process.env.NEXT_PUBLIC_BASE_URL}/terminos-condiciones`}
        description="Fórmate como desarrollador FullStack de forma gratuita."
        openGraph={{
          type: 'website',
          description: `Fórmate como desarrollador FullStack de forma gratuita.`,
          title: `${process.env.NEXT_PUBLIC_BASE_NAME} | Fórmate gratis como desarrollador fullstack`,
          url: `${process.env.NEXT_PUBLIC_BASE_URL}/terminos-condiciones`,
        }}
      />
      ...
      <BreadcrumbJsonLd
        itemListElements={[
          ...
          { position: 2, name: 'Términos y condiciones', item: `${process.env.NEXT_PUBLIC_BASE_URL}/terminos-condiciones` },
        ]}
      />
    </>
  );
